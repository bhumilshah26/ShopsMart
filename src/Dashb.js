...
//             <li>
//               <Link to="#0" className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex py-1 px-3">
//                 Option 1
//               </Link>
//             </li>
//             <li>
...
//             </li>
//             <li>
//               <Link to="#0" className="font-medium text-sm text-rose-500 hover:text-rose-600 flex py-1 px-3">
//                 Remove
//               </Link>
//             </li>
//           </EditMenu>
